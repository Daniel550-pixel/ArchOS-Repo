...
export const UltronCommandCenter: React.FC<Props> = ({ compact = false }) => {
  ...
  const cognitiveState = useMemo<UltronCognitiveState>(() => ({ epoch: activeEpoch, graphNode, commandSurface: "ULTRON_COMMAND_CENTER", activeModule: "GEMINI_COGNITIVE", stateVersion }), [activeEpoch, graphNode, stateVersion]);
